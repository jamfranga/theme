        ...
        <ul class="nav-main">
          <li class="nav-main-item">
            <a class="nav-main-link{{ request()->is('dashboard') ? ' active' : '' }}" href="/admin">
              ...
              <span class="nav-main-link-name">Portada</span>
            </a>
          </li>
          ...
          <li class="nav-main-heading">Secciones</li>
          <li class="nav-main-item{{ Route::is('admin.noticias.index') ? ' open' : '' }}">
            <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="true" href="#">
            ...
            <ul class="nav-main-submenu">
              <li class="nav-main-item">
                <a class="nav-main-link {{ Route::is('admin.noticias.index') ? ' active' : '' }}" href="{{ Route('admin.noticias.index') }}">
                  <span class="nav-main-link-name">Noticias</span>
                </a>
              </li>
              <li class="nav-main-item">
